...
import {
  CcGisViewer as CcGisViewer
} from './components/cc-gis-viewer/cc-gis-viewer';

declare global {
  interface HTMLCcGisViewerElement extends CcGisViewer, HTMLElement {
  }
  var HTMLCcGisViewerElement: {
    prototype: HTMLCcGisViewerElement;
    new (): HTMLCcGisViewerElement;
  };
  interface HTMLElementTagNameMap {
    "cc-gis-viewer": HTMLCcGisViewerElement;
  }
  interface ElementTagNameMap {
    "cc-gis-viewer": HTMLCcGisViewerElement;
  }
  namespace JSX {
    interface IntrinsicElements {
      "cc-gis-viewer": JSXElements.CcGisViewerAttributes;
    }
  }
  namespace JSXElements {
    export interface CcGisViewerAttributes extends HTMLAttributes {
